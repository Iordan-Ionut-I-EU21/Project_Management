...
public interface ProcessLogRepository extends JpaRepository<ProcessLog, String> {
    ...
    List<ProcessLog> findByUserNameAndStatus(@Param("name") final String name, @Param("status") String status, Pageable pageable);
    ...
    Long countByUserNameAndStatus(@Param("name") final String name, @Param("status") String status);
}